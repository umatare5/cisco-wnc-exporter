...
// apBandDescs holds the descriptors of the band-keyed air quality series. A nil value
// means the spectrum module is disabled, which is what keeps them out of a default
// scrape.

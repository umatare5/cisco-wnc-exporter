...
// TestAPGeolocationModule_PublishesThePairOrNeither keeps a half-published position out of the
...
func TestAPGeolocationModule_PublishesThePairOrNeither(t *testing.T) {
	t.Parallel()
...
// TestAPGeolocationModule_SkipsARowWithNoKey keeps an empty mac label out of the metrics. The schema
...
func TestAPGeolocationModule_SkipsARowWithNoKey(t *testing.T) {
	t.Parallel()
